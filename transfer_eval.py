...
if len(sys.argv) < 6:
    print("Usage: transfer.py <base_game> <start> <finish> <extra> <mode> - mode is simple or complex")
    exit(0)
...
if simple:
    ...
    model = Model(propnet, transfer=True, base_dims=bd, roles_dim=[])
